export default function Navbar({ children }) {
    return (
        <div>
            <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 m-1.5">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <a href="" className="flex items-center">
                        <img src='interlocutorLogo.png' className="m-1.5" alt="Logo" width={30} height={30}/>
                        <span
